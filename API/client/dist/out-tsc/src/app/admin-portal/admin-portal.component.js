...
let AdminPortalComponent = class AdminPortalComponent {
    ...
    populateDashboard() {
        ...
        this.dashService.salesAverage(this.referenceService.currentBranch()).subscribe(response => {
            console.log(response);
            this.salesAverage = response;
        }, error => {
            console.log(error);
        });
        this.dashService.revenueAverage(this.referenceService.currentBranch()).subscribe(response => {
            console.log(response);
            this.revenueAverage = response;
        }, error => {
            console.log(error);
        });
        this.dashService.itemsAverage(this.referenceService.currentBranch()).subscribe(response => {
            console.log(response);
            this.itemsAverage = response;
        }, error => {
            console.log(error);
        });
        this.dashService.orderSource(this.referenceService.currentBranch()).subscribe(response => {
            console.log(response);
...
export { AdminPortalComponent };
//# sourceMappingURL=admin-portal.component.js.map