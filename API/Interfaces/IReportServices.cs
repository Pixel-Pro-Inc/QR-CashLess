...
namespace API.Interfaces
{
    ...
    {
        /// <summary>
        /// Finds the total sales made in the time period give by the <see cref="ReportDto"/> due for the user
        /// <para> 
        /// It use the <see cref="ReportDto.StartDate"/> and <see cref="ReportDto.EndDate"/>
        /// </para>
        /// </summary>
